...
hotel_id = read.csv(args[1], header=FALSE, sep="")
...
# Load the same csv
file_name <- paste(dest_dir,"/tripadvisor_reviews.csv", sep="")
dest_file<- paste(dest_dir,"/sentiment", sep="")
